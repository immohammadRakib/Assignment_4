...
export default {
    ...
    client_url: process.env.CLIENT_URL || "https://assignment-5-git-main-rakiblp6gmailcoms-projects.vercel.app" ||"https://assignment-5-lovat.vercel.app" || "http://localhost:3000",
