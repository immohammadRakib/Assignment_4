...
const initialPayment = async (bookingId: string, user: User) => {
    ...
    const paymentData = {
        ...
        currency: "BDT",
        tran_id: tranId,
        success_url: `${config.app_url}/api/payments?tranId=${tranId}&bookingId=${bookingId}`,
        fail_url: `${config.app_url}/api/payments?tranId=${tranId}&bookingId=${bookingId}`,
        cancel_url: `${config.app_url}/api/payments?tranId=${tranId}&bookingId=${bookingId}`,
